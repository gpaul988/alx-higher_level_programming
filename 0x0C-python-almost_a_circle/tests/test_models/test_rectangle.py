#!/usr/bin/python3
# Graham S. Paul (test_rectangle.py)
"""
Factor Assessment for Rectangle Class
"""
...
class TestBase(unittest.TestCase):
    """Assessments for models/rectangle.py"""

    """Test attributes"""
    def test_all_attr_given(self):
        """Inspect all features match what's given"""
    ...
    def test_default_attr(self):
        """Original Assessment features are set when not given"""
        r2 = Rectangle(3, 4)
    ...
    def test_private_attr_access(self):
        """Personal Assessment features are not accessible"""
    ...
    def test_invalid_args(self):
        ...
        """Assessment too small args given throws error"""
        with self.assertRaises(TypeError):
            Rectangle(1)
            Rectangle()
            Rectangle(None)
    ...
    def test_update(self):
        ...
        """Assessment mixture of valid and invalid *kwargs"""
